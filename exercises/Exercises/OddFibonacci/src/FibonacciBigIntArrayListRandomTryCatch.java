...
public class FibonacciBigIntArrayListRandomTryCatch {

    public static void main(String[] args) {
        //Generate a random number from 1 to 100
        int max = getRandomNumberInRange(1, 1000000000);
    ...
    public static ArrayList<BigInteger> generateFibonacci(int fmax) {
        try {
            ...
            System.out.println("The maximum value passed to the method is too large. Please try a smaller value.");
            return null;
        }
    }
